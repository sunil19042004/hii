  ...
  return (
    <div>
            <nav class="navbar background">
                <ul class="nav-list">
                    <div class="logo">
                        <img src="https://logo-all.ru/uploads/posts/2016-04/0_marketplace_logo.jpg" />
                    </div>
                    <li><a href="#courses">Home</a></li>
                    <li><a href="#tutorials">Specs</a></li>
                    <li><a href="#jobs">Features</a></li>
                    <li><a href='#student' onClick={handleHome}>Process</a></li>
                    <li><a href='#payment' onClick={handlepayment}>Payment</a></li>
                </ul>
  
                <div class="rightNav">
                    <input type="text" name="search" id="search" />
                    <button class="btn btn-sm"><a href='https://64f1703956155b26ca1263f0--bespoke-dango-e262e5.netlify.app/'>Search</a></button>
                </div>
            </nav>
